  ...
  return (
    <>
      ...
      <p className="main-text">
        A passionate Fullstack Web Developer, with production-level work experience
        ...
        the Israeli intelligence unit. Just like I learned German on my own,
        moved to Austria and got my chemistry degree in German, when I set my mind to
